...
class CartController extends AbstractController
{
    ...
    /**
     * @Route("/cart/remove/{productId}", name="app_cart_remove", methods={"POST"})
     */
    ...
    /**
     * @Route("/cart/increment/{productId}", name="app_cart_increment", methods={"POST"})
     */
    ...
    /**
     * @Route("/cart/decrement/{productId}", name="app_cart_decrement", methods={"POST"})
     */
